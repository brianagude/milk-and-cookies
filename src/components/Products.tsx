        ...
        {products.length < 4 ? (
          ...
          <div className="relative">
            ...
            <div>
              ...
              >
                <Image src="/arrow.svg" width={40} height={40} alt="left arrow"/>
              </button>
              <button
                type="button"
                onClick={scrollNext}
              ...
              >
                <Image src="/arrow.svg" width={40} height={40} alt="right arrow" className="rotate-180"/>
              </button>
            </div>
  ...
  return (
    <div key={product._key} href={product.link} className="border-4 block">
      ...
      <div className="px-4 py-6 border-t-4 bg-white sm:px-6 sm:py-8">
        ...
        <Button url={product.link} style="secondary" classes="flex flex-wrap gap-3 items-center justify-between !w-full mt-5 xl:mt-8">
          purchase
