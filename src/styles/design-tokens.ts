export const spacing = {
  section: 'relative scroll-mt-2 py-16 max-w-[1728px] mx-auto border-l-4 border-r-4 md:py-20 lg:py-32',
  container: 'w-full max-w-[1728px] mx-auto px-4 flex flex-col space-y-12 sm:px-6 md:space-y-16 md:px-8 lg:px-20',
}
...
export const forms = {
  input: 'p-4 rounded border-2 border-black bg-cream color-black focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-yellow placeholder-black/70 text-base disabled:text-black/20 disabled:cursor-not-allowed',
  label: 'px-4',
